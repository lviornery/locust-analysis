function systemsol = de_ground_systemsol(t,z,p)
...
rhs = gen_ground_secondderivativesrhs(bodyXForce,bodyYForce,dq1,dq2,dtheta,dx,dy,p.g,p.hhip,hipTorque,kneeTorque,p.lfemur,p.lhip,p.ltibia,p.mbody,p.mfemur,p.mtibia,q1,q2,supportTorque,theta);
invm = gen_ground_secondderivativesinvm(p.Ibody,p.Ifemur,p.Itibia,p.hhip,p.lfemur,p.lhip,p.ltibia,p.mbody,p.mfemur,p.mtibia,q1,q2,theta,x,y);
systemsol = invm\rhs;